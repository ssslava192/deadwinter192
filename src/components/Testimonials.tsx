...
const testimonials = [
  ...
  {
    role: 'Криптотрейдер',
    text: 'Вячеслав максимально быстро смонтировал мне интересный Reels! Очень порадовало, что он отвечает моментально — ничего не пришлось ждать. Всё сделал чётко, качественно и с отличным результатом.',
  },
  {
    role: 'Бренд одежды',
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <div className="pt-4 border-t border-white/5">
                <p className="text-white text-3xl font-steelfish tracking-wider uppercase">
                  {t.role}
                </p>
              </div>
            </div>
